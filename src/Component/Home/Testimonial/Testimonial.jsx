...
const Testimonial = () => {
    return (
        <div className='container font-fontIbm mx-auto pt-20'>
            <h3 className='md:text-5xl md:text-start text-center text-3xl text-black font-semibold'>
                    ...
                    <div className='w-[400px]'>
                        {
                            testimonial.map(item => (
                                 <SwiperSlide className='!w-[500px]'  key={item.id}>
                                    {/* style */}
                                    <div className="card  font-fontIbm bg-slate-100 py-10 hover:shadow-lg hover:bg-green-200 shadow-xl">
