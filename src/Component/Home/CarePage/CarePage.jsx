...
const CarePage = ({img}) => {
    ...
    return (
        <div className='mt-36 py-28 px-2 container mx-auto grid gap-6 lg:gap-2 bg-slate-50 items-center grid-cols-1 md:grid-cols-2'>
            {/* img part */}
            ...
            <div className='space-y-6 font-fontIbm'>
                <h3 className='md:text-7xl text-4xl font-bold'>The Importants To Take Care Of Yourself</h3>
